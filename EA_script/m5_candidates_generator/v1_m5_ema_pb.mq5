...
input string InpFileName = "xau_m5_candidates_ea1.csv";
...
input double MinBodyPts = 30;   // body filter in points
...
int OnInit()
{
   ...
   hAtrM5=iATR(_Symbol,PERIOD_M5,ATR_period);
...
void OnTick()
{
   ...
   if(t15!=tH1 || t15==TR_NEUTRAL) return;
   ...
   double atr=BufValue(hAtrM5,1)/_Point;
